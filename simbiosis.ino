...
GrupoSensor grupoSensor1("grupo1");
//GrupoSensor grupoSensor2("grupo2");



AdministradorPistas administradorPistas;

Pista pista1(
  "Grave 4",
  1,          // canal midi
  0, 100,     // min / max volume
  0,          // eqMin
  100         // eqMax 
);
...
void setup() {
  administradorPistas.agregarPista(&pista1);  
  //grupoSensor1.asignarPista(&pistas[0]);
...
void loop() {
  ...
  grupoSensor1.loop(tempsA);
  //grupoSensor2.loop(tempsB);
  //Serial.println();
